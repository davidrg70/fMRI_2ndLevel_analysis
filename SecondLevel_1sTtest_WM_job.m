% 2nd Level analysis (1 SAMPLE T-test) for WM task (2 CONTRASTS: Encoding>Retrieval & Encoding<Retrieval)
clear all; clc;
...
% the con_0002.nii corresponds to the Encoding<Retrieval comparison!
% The contrast vector must be 1100 for Patients>Controls for E>R and
% -1-100 for Patients>Controls for R>E, when using
...
spm('defaults','fmri');
spm_jobman('initcfg');
matlabbatch{1}.spm.stats.factorial_design.dir = {'/home/uni10/nmri/projects/dgarnica/MRI_EEG_PROSPECTIVE/SecondLevel_1sTtest_WM'};
...
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [-1,0,0,0];
