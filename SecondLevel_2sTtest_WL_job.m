...
contrasts = {'Patients>Controls: Animals>Fractals', 'Controls>Patients: Animals>Fractals'};
% contrasts = {'Patients>Controls: Fractals>Animals', 'Controls>Patients: Fractals>Animals'};
...
% The patients>controls contrast designs must be 1-100 for A>F and 
...
% Check/distinguish patients from controls
